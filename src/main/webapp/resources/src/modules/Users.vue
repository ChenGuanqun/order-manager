  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item label="权限" label-width='80px'>
          <el-select v-model="formInline.roleName" placeholder="请选择">
    ...
    <el-table
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button @click="handleDelete(scope.row)" type="text" v-if="isShowEnable(scope.row)" size="mini">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!--</el-row>-->
...
//            console.info(this.roles);
      ...
      handleResetKey(row) {
        request.updateUser({password: 123456, id: row.id}).then(res => {
          if (res.data.code == 200 && res.data.result) {
            this.$message({
              message: '密码重置成功!',
              type: 'success'
